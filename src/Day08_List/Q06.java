...
public class Q06 {
    ...
    public static void main(String[] args) {
        ...
        int arrTekrarsiz[] = new int[tekrarsiz.size()];//listein elemný kadar arr olusturuldu

        
        for (int i = 0; i < arrTekrarsiz.length; i++) {//bu dongude istein elemnarý array eklendi
