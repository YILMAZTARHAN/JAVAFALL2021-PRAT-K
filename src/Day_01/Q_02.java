...
public class Q_02 {
	...
	public static void main(String[] args) {
		...
		System.out.println(" \"Hello \", \"Yýlmaz \\ / \"  ");
		...
		// 'asiktir'  yazdýrýnýz sonraki "TechProEd ile java cok kolay ...
		//ifadesi  3 satýr sonra ve satýr basýndan 1 tab ilerideyazýlsýn.
		
		System.out.println("\"Baþarý\" gayrete \n \'aþýktýr\' \n\n\n \t\"TechProEd ile java çok kolay...\"");*/
